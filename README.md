...
but rather to present the inner workings of them in a transparent and accessible way. This repository is an inspiration from https://github.com/eriklindernoren/ML-From-Scratch, but the implementations are my own.
